...
Скопируёте и вставьте ссылку:
 ...
 "Глушат" мобильный интернет-"белый список", поэтому дублирую каналы.
 Пишите что нужно или не работает, постараюсь исправить. КВН нужно выключить или переключать локации, трансляции в одном положении не все работают. Оптимальный вариант не нашел.
